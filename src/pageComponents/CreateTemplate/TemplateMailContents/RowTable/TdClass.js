...
export default function TdClass({
  ...
  useEffect(() => {
    ...
    if (colIndex === undefined) {
      ...
      newContents.body.contentRowTables[rowTableIndex].tdClasses[colIndex][rowIndex] = {
        ...tdClass,
        bgcolor: tdBgcolor,
        width: tdWidth,
        height: tdHeight,
              ...
              synkEditorToResult={(image) => {
                ...
                <img
                    ...
                    style='
                      ...
                      padding: 0px;
                      margin: 0px;
                      border-radius: ${tdBorderRadius}px;
...
const MenuToggle = styled.button`
  ...
  font-size: 2px;
  font-weight: 800;
  left: ${props=>{if(props.width<20)return -5; else return 5}}px;
  top: ${props=>{if(props.height<20)return -5; else return 5}}px;
`;
